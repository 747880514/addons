...
function(ui, gSelector) {
    ...
    modal.initPage = function(initE) {
        ...
        var backgroundColor = modal.page.background +','+ modal.page.backgrounds +','+ modal.page.backgroundss;
        $("#phone").css(
            {
                'background': "-webkit-linear-gradient("+backgroundColor+")",
                'background': "-o-linear-gradient("+backgroundColor+")",
                'background': "-moz-linear-gradient("+backgroundColor+")",
    ...
    modal.initEditor = function(scroll) {
        ...
        if (scroll) {
            $("#diy-editor").unbind('animate').animate({
                "margin-top": top - 130 + "px"
            });
            setTimeout(function() {
                $("body").unbind('animate').animate({
                    scrollTop: top - 130 + "px"
                },
                1000)
            },
            1000)
