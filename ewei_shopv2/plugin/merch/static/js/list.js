define(['core', 'tpl'], function (core, tpl) {
    ...
    modal.getList = function () {
        ...
        geolocation.getCurrentPosition(function (r) {
            ...
            //默认 merch/list/ajaxmerchuser
            //百里 merch/baili/ajaxmerchuser
            core.json('merch/baili/ajaxmerchuser', {page: modal.page, keyword: modal.keyword, cateid: modal.cateid, lat: modal.lat, lng: modal.lng, range: modal.range, sorttype: modal.sorttype}, function (ret) {
